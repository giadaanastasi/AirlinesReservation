        ...
        out.println("</tr>");
            for(int i=0; i<6; i++){
                ...
                for(int j=0; j<15; j++){
                    ...
                    if(res.isEmpty()){
                        out.println("<td><button name=\""+i+"_"+j+"\" id=\"libero\" value=\"${flightList.idvolo}\" onclick=\" clickButton(this, "+postiSel+", "+this.lista_posti+")\" ><img class=\"img_content_section\" src =\"C:/Users/giada/OneDrive/Documents/GitHub/AirlinesReservation/src/java/seat.png\"></button></a></td>");
                    } else{
